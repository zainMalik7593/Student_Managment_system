...
<body>
    ...
    <div style="top: 10px;" id="submitpage" class="d-block position-absolute top-2 shadow w-50"> Class Attendance Record!</div>
    <div style="border: 5px solid #ab1316; display: none;" class="container form">
        <form id="admissionForm" method="post" action="group_attendance_report.php" class="row g-3 needs-validation" novalidate>
            ...
            <div class="row mt-4 mb-4 text-center">
                <div class="col-12">
                    <button class="btn btn-lg btn-primary" id="check" name="check" type="submit" value="check">Generate report</button>
                </div>
            </div>
        </form>
    </div>
        ...
        $('document').ready(function () {
            $('form').submit(function (event) {
                if ($(this)[0].checkValidity() === false) {
                    ...
                    window.location.href = "group_attendance_report.php";
                }
            });
        });
    </script>
